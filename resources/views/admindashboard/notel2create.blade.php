...
<div class="container">
    ...
    <form action="{{route('notel2admin')}}" method="POST">
        @csrf
                            ...
                            @for ($ue = 1; $ue <= 5; $ue++)
                                @for ($mat = 1; $mat <= 3; $mat++)
                                    ...
                                    <td>
                                        <input
                                            type="number"
                                            name="notesl2[{{ $etudiant->id }}][ue{{ $ue }}_m{{ $mat }}_dev1]"
                                            value="{{ old('notesl2.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_dev1', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
                                    ...
                                    <td>
                                        <input
                                            type="number"
                                            name="notesl2[{{ $etudiant->id }}][ue{{ $ue }}_m{{ $mat }}_dev2]"
                                            value="{{ old('notesl2.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_dev2', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
                                    ...
                                    <td>
                                        <input
                                            ...
                                            value="{{ old('notesl2.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_exam', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
