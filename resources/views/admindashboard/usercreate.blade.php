...
<form method="POST" action="{{route ('useradmin') }}" class="modern-form">
...
@endif
    ...
    <div class="form-body">
        ...
        <div class="input-group">
            <div class="input-wrapper">
                ...
                <input name="firstname" value="{{ old('firstname') }}" required placeholder="Nom" class="form-input" type="text" />
            </div>
        </div>
        @error('firstname')
        ...
        <div class="input-group">
            <div class="input-wrapper">
                ...
                <input name="lastname" value="{{ old('lastname') }}" required placeholder="Prénom" class="form-input" type="text" />
            </div>
        </div>
        @error('lastname')
            <span class="text-danger">{{ $message }}</span>
        @enderror
         ...
         <div class="input-group">
            <div class="input-wrapper">
                <select   name="niveau" required style="width: 345px; height: 42px; border-radius: 7px; color:grey; ">
        ...
        <div class="input-group">
            <div class="input-wrapper">
                <select   name="role" required style="width: 345px; height: 42px; border-radius: 7px; color:grey; ">
    ...
    <button class="submit-button" type="submit">
        <span class="button-text">créer le compte</span>
