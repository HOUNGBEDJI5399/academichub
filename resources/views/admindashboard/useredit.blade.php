...
<style>
    ...
    <form method="POST"  action="{{ route('userupdate',$user) }}"   class="modern-form" " >
    @csrf
    @method('put')
   ...
   @endif
    ...
    <div class="form-title">Modification de compte utilisateur</div>
    ...
    <div class="form-body">
        <div class="input-group">
            <div class="input-wrapper">
                ...
                <input required=""  value="{{$user->firstname}}"  name="firstname" placeholder="Nom" class="form-input" type="text" />
            </div>
        </div>
        ...
        <div class="form-body">
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <input  name="lastname"   value="{{$user->lastname}}"  required="" placeholder="Prénom" class="form-input" type="text" />
                </div>
            </div>
            @error('lastname')
            <span style="text-danger">{{$message}}</span>
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <input  name="email" required=""   value="{{$user->email}}"  placeholder="Email" class="form-input" type="email" />
                </div>
            </div>
            @error('email')
            <span style="text-danger">{{$message}}</span>
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <select style="width: 280px; height: 42px; border-radius: 7px;color:grey; "  required='' name="role"  value="{{old('role')}}"   >
