...
<div class="container">
        ...
        @foreach($groupedPresences as $key => $group)
            ...
            <div class="presence-sheet">
                <div class="course-info">
                    <p><strong>Date:</strong> {{ $first->created_at->format('d/m/Y') }}</p>
                ...
                <div class="actions">
                    <form action="{{ route('adminpresencedestroy', $first) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette feuille de présence?')">
                            Supprimer
                        </button>
                    </form>
                </div>
    ...
    @else
        <div class="empty-state">
            <p>Aucune feuille de présence n'est disponible pour le moment.</p>
        </div>
    @endif
</div>
@endsection