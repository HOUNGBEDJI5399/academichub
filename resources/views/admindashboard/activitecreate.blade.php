...
<style>
    ...
    <form  method="POST" action="{{route('activiteadmin')}}" class="modern-form">
    @csrf
   ...
   @endif
        ...
        <div class="form-title">Création d'une activité</div>
        ...
        <div class="form-body">
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <input required="" name="title"  placeholder="Titre de l'activité" class="form-input" type="text" />
                </div>
            </div>
             @error('title')
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    <svg fill="none" viewBox="0 0 24 24" class="input-icon">
                      ...
                      <input required=""  name="domaine" placeholder="Domaine" class="form-input" type="text" />
        ...
        @enderror
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <input required=""  name="jour_heur" placeholder="Jour et horaire (ex: Mardi, 18h-20h)" class="form-input" type="text" />
                </div>
            </div>
        ...
        @enderror
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <textarea required=""   name="description" placeholder="Description de l'activité" class="form-textarea"></textarea>
                </div>
            </div>
        </div>
         @error('description')
        ...
        <button class="submit-button" type="submit">
            <span class="button-text">Créer l'activité</span>
