...
<div class="container">
    ...
    <form action="{{route('noteadmin')}}" method="POST">
        @csrf
                            ...
                            @for ($ue = 1; $ue <= 5; $ue++)
                                @for ($mat = 1; $mat <= 3; $mat++)
                                    ...
                                    <td>
                                        <input
                                            type="number"
                                            name="notes[{{ $etudiant->id }}][ue{{ $ue }}_m{{ $mat }}_dev1]"
                                            value="{{ old('notes.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_dev1', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
                                    ...
                                    <td>
                                        <input
                                            type="number"
                                            name="notes[{{ $etudiant->id }}][ue{{ $ue }}_m{{ $mat }}_dev2]"
                                            value="{{ old('notes.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_dev2', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
                                    ...
                                    <td>
                                        <input
                                            type="number"
                                            name="notes[{{ $etudiant->id }}][ue{{ $ue }}_m{{ $mat }}_exam]"
                                            value="{{ old('notes.'.$etudiant->id.'.ue'.$ue.'_m'.$mat.'_exam', '') }}"
                                            min="0" 
                                            max="20" 
                                            step="0.25"
                                            class="note-input"
