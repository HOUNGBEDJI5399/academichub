...
<div class="main-content">
    ...
    <div class="header">
        ...
        <div class="header-actions">
            ...
            <a href="{{ route('admindashboard.notecreate') }}" class="btn btn-success">
    ...
    <div class="container">
        <h2><i class="fas fa-table"></i>  Notes  L1</h2>
                ...
                <tbody id="tableBody">
                    @forelse ($notes as $note)
                        <tr>
                            ...
                            @for ($ue = 1; $ue <= 5; $ue++)
                                @for ($mat = 1; $mat <= 3; $mat++)
                                    <td class="note-cell {{ getNoteClass($note->{"ue{$ue}_m{$mat}_dev1"}) }}">
                                        {{ $note->{"ue{$ue}_m{$mat}_dev1"} ?? '-' }}
                                    </td>
                                    <td class="note-cell {{ getNoteClass($note->{"ue{$ue}_m{$mat}_dev2"}) }}">
                                        {{ $note->{"ue{$ue}_m{$mat}_dev2"} ?? '-' }}
                                    </td>
                                    <td class="note-cell {{ getNoteClass($note->{"ue{$ue}_m{$mat}_exam"}) }}">
                                        {{ $note->{"ue{$ue}_m{$mat}_exam"} ?? '-' }}
                                    </td>
                                @endfor
                            @endfor
                            <td class="actions-cell">
                                <a href="{{ route('admindashboard.noteedit', $note->id) }}" class="btn btn-sm btn-primary">
