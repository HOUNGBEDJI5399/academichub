...
<style>
    ...
    <form method="POST" action="{{ route ('annonceupdate'  , $annonce)  }} " class="modern-form" >
        ...
        <div class="form-body">
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <input required="" value="{{$annonce->title}}" name="title" placeholder="Titre de l'annonce" class="form-input" type="text" />
                </div>
            </div>
            ...
            <div class="input-group">
                <div class="input-wrapper">
                    ...
                    <textarea required name="description" placeholder="Description de l'annonce" class="form-textarea">{{ $annonce->description }}</textarea>
