...
.club{
        background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.9)),url(<?php echo e(asset('image/carousel-1.jpg')); ?>);
        background-size: 110%; 
...
<body>
    ...
    <section class="join-club">
        <a href="<?php echo e(route('etudiantdashboard.inscritclub')); ?>" class="join-button">S'inscrire à un club</a>
    ...
    <section class="clubs-container">
        <div class="clubs-row">
            ...
            <div class="club-card" style="--i:1">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club1.1.jpg')); ?>" alt="Club Football">
                </div>
            ...
            <div class="club-card" style="--i:2">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club2.jpg')); ?>" alt="Club Basketball">
                </div>
                <div class="club-content">
            ...
            <div class="club-card" style="--i:3">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club4.jpg')); ?>" alt="Club Otaku">
                </div>
                <div class="club-content">
        ...
        <div class="clubs-row">
            ...
            <div class="club-card" style="--i:4">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club5.jpg')); ?>" alt="Club Tech">
                </div>
                <div class="club-content">
            ...
            <div class="club-card" style="--i:5">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club3.jpg')); ?>" alt="Club Danse">
                </div>
                <div class="club-content">
            ...
            <div class="club-card" style="--i:6">
                <div class="club-image">
                    <img src="<?php echo e(asset('image/club6.jpg')); ?>" alt="Club Musique">
                </div>
                <div class="club-content">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Documents\AcademicHub\gestionacademic\resources\views/etudiantdashboard/club.blade.php ENDPATH**/ ?>