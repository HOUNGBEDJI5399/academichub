        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-book-open me-2"></i> Ajouter un nouveau cours
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('courprof') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nom_cour') is-invalid @enderror"
                                id="nom_cour" name="nom_cour" value="{{ old('nom_cour') }}"
                                placeholder="Entrez le nom du cours" required>
                            @error('nom_cour')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('categorie') is-invalid @enderror"
                                ...
                                <option value="L1" {{ old('categorie') == 'L1' ? 'selected' : '' }}>Licence 1</option>
                                <option value="L2" {{ old('categorie') == 'L2' ? 'selected' : '' }}>Licence 2</option>
                                <option value="L3" {{ old('categorie') == 'L3' ? 'selected' : '' }}>Licence 3</option>
                            </select>
                            @error('categorie')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            <label>
                                <i class="fas fa-file-upload me-2"></i>Documents de cours
                            </label>
